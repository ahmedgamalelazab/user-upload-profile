...
class LoginScreen extends StatelessWidget {
  static const String LOGIN_ROUTE = "/LoginScreen";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: applicationAppbar(context, "Login"),
      body: Column(
        children: [
          Form(
            key: formKey,
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                            ...
                            minimumSize: MaterialStateProperty.all(
                              Size(
                                  DeviceSizeConfigUtils.getDeviceWidth(
                                          context) *
                                      0.85,
                          ...
                          onPressed: () {
                            ...
                            BlocProvider.of<AuthBloc>(context).add(
                              Login(
                                signIn: SignIn.fromJson(formBody),
                              ),
                            );
          ...
          Container(
            alignment: Alignment.center,
            width: DeviceSizeConfigUtils.getDeviceWidth(context),
            height: DeviceSizeConfigUtils.getDeviceHeightWithoutNotificationBar(
                    context) *
                0.080,
            color: Theme.of(context).primaryColor,
            child: ApplicationBarsFonts(
              barTitle: "Profile App",
...
class UserFormBuilderFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      obscureText: uniqueSerial == 'USERPASSWORD' ? true : false,
      validator: (value) {
        if (uniqueSerial == "USEREMAIL") {
          bool isMatch = RegExp(
